...
header('Location: http://qc-research.science/mobile.html');
session_start();
echo '
<!DOCTYPE html>
<html>
...
<body>
    ...
    All your responses will be anonymous and you can choose to quit at any time.<br><br>
    ...
    <input type="submit" style="float: right;" class="button" value="Start">
    </div>
    </form>
</body>
</html>
